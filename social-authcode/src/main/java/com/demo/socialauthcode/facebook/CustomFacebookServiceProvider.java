...
public class CustomFacebookServiceProvider extends AbstractOAuth2ServiceProvider<Facebook> {
	...
	private static OAuth2Template getOAuth2Template(String appId, String appSecret, String apiVersion) {
		...
		OAuth2Template template = new OAuth2Template(appId, appSecret,
				"https://www.facebook.com/v" + apiVersion + "/dialog/oauth", graphApiURL + "oauth/access_token");
	...
	public Facebook getApi(String accessToken) {
		...
		System.out.println("getAPI accessToken: " + accessToken);
		return template;
	}

	@Override
	public String toString() {
		return "CustomFacebookServiceProvider [appNamespace=" + appNamespace + ", apiVersion=" + apiVersion + "]";
	}
